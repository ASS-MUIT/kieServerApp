...
🖥️ GUI: añadir un usuario que tenga el rol `rest-all`, que concede credenciales para acceder a la API de BC. Este usuario tiene que estar configurado también en el servidor kie.
...
### ▶️ Ejecución
1. 🚀 Arrancar Business Central

2. 🔧 Al ejecutar `.\launch-dev.bat clean install` se arrancará un servidor kie conectado business central.
   Podrá verse el servidor en la vista de servidores de ejecución con el nombre **kieserverapp-dev@localhost:8090**

3. 📦 A partir de ese momento se pueden desplegar en este servidor contenedores definidos en business central

4. 🔄 Posteriormente se pueden ejecutar los procesos desplegados en el contenedor desde business central.
...
🗄️ También se ha configurado para que la consola h2 esté disponible en `/h2-console`, para así facilitar la depuración.
